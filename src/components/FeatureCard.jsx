...
const FeatureCard = ({title, description, Icon}) => {
    ...
    return (
        <div className='md:w-1/3 p-9 sm:px-11 py-12 sm:py-18 md:py-10 flex flex-col rounded-[3px] justify-between sm:justify-around space-y-14 sm:space-y-14 md:space-y-10 backdrop-blur-md bg-[#FFFFFF0A]'>
