...
const FeatureCard = ({title, description, Icon}) => {
    ...
    return (
        <div className='md:w-[65%] lg:w-1/3 p-9 sm:px-11 md:px-14 py-12 sm:py-20 md:py-16 flex flex-col rounded-[3px] justify-between sm:justify-around space-y-14 sm:space-y-14 md:space-y-14 backdrop-blur-md bg-[#FFFFFF0A]'>
