    ...
    return (
        <nav className='pt-8'>
            <div className='w-[84%] md:w-[90%] md:max-w-4xl lg:max-w-5xl mx-auto h-10 flex items-center justify-between z-1000'>
                ...
                {/* nav menu for mobile */}
                <Slide direction='down' className={`border ${navMenuOpen === true ? 'sm:flex' : 'hidden'} md:hidden sm:flex-col absolute w-[90%] h-[80vw] left-6 top-24 z-30 space-y-3 pt-5 bg-[#171717f2] border border-[#FFFFFF1A] backdrop-blur-3xl shadow rounded-lg`}>
