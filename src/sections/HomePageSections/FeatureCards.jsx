...
const FeatureCardsSection = () => {
    ...
    return (
        <section className='w-[85%] sm:w-[70%] md:w-[90%] md:max-w-4xl lg:max-w-5xl mx-auto flex flex-col md:flex-row items-center md:items-stretch flex-wrap lg:flex-nowrap justify-between md:justify-center lg:justify-between lg:space-x-6 space-y-16 lg:space-y-0 mt-32 md:mt-20'>
