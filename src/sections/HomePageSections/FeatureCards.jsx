...
const FeatureCardsSection = () => {
    ...
    return (
        <section className='w-[85%] sm:w-[70%] md:w-[90%] md:max-w-4xl lg:max-w-5xl mx-auto flex flex-col md:flex-row md:flex-wrap items-center md:items-stretch justify-between md:justify-center lg:justify-between md:space-x-6 space-y-16 md:space-y-14 mt-32 md:mt-20'>
