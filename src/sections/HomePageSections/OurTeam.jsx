    ...
    return (
        <section id='about' className='flex flex-col md:flex-row items-center md:max-w-4xl lg:max-w-5xl mx-auto mt-36 md:mt-24 px-3 space-y-20 md:space-y-0'>
            <div className="text flex flex-col items-center sm:items-start w-[100%] sm:w-[80%] md:w-1/2 space-y-4 sm:space-y-3 md:space-y-2">
                ...
                <p className='md:text-sm text-lighterWhite leading-loose md:leading-8 sm:leading-loose w-[95%] md:max-w-md pt-6 sm:text-start'>Our team consists of many creative people. We are committed to maintaining quality work as well as speed. These creative people work together to create maximum work results.</p>
