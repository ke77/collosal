...
const Services = () => {
    return (
        <section id='services' className='flex flex-col items-center justify-evenly md:h-[680px] max-w-6xl mx-auto text-center mt-32 bg-[#221048] lg:rounded-[30px] py-24 md:py-0 space-y-24 md:space-y-0'>
            <div className="text space-y-4 sm:space-y-3 w-[85%] h-[15%] -mt-5">
