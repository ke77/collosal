...
const Projects = () => {
    return (
        <section className='flex flex-col justify-between sm:items-center md:items-stretch max-w-5xl w-[90%] sm:w-[80%] sm:w-5xl mx-auto mt-24 text-center space-y-20 md:space-y-12 px-8 pt-24 sm:pt-28 md:pt-24 md:h-[800px] border-t border-t-[#FFFFFF2A]'>
